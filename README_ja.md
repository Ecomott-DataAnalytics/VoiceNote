...
| Qwen3-ASR | `Qwen/Qwen3-ASR-0.6B` | qwen3 | 多言語 | 6〜10GB |
| Qwen3-ASR | `Qwen/Qwen3-ASR-1.7B` | qwen3 | 多言語 | 12〜20GB |

**用途の目安**：既定=ReazonSpeech k2-v2（日本語・軽量） / 高精度=Kotoba v2.2（話者分離・議事録向け） / 最高精度=Qwen3-ASR 1.7B（多言語・重い） / 多言語汎用=Whisper Large-v3。
